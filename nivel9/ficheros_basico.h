...
#define RED "\x1b[31m"
#define BLUE "\x1b[34m"
#define BLUE_S "\x1b[44m"  // S de subrayado
#define YELLOW_S "\x1b[43m"
...
struct inodo {     // comprobar que ocupa 128 bytes haciendo un sizeof(inodo)!!!
   ...
   /* Por cuestiones internas de alineación de estructuras, 
   la palabra utilizada sea del tamaño de 8 bytes
...
//int liberar_recursivamente(unsigned int nblog,unsigned int nivel_punteros,
 //unsigned int nbloque_punteros);
